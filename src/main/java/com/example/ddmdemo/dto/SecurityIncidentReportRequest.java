...
public record SecurityIncidentReportRequest(
        String employeeName,
    ...
    public static final class Builder {
        ...
        public SecurityIncidentReportRequest build() { return new SecurityIncidentReportRequest(employeeName, securityOrganizationName, affectedOrganizationName, severityLevel, affectedOrganizationAddress, reportContent); }
    }
}
